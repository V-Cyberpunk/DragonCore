...
SELECT @POOLID := @POOLID+1;
SET @OGUID := 0;
SELECT @OGUID := MAX(guid) FROM `gameobject`;
SELECT @OGUID := @OGUID+1;
...
(@OGUID, 2844, 530, 3524, 3567, "", 0, 0, 0, -1, -4434.80810546875, -11967.896484375, 32.12919235229492187, 3.159062385559082031, 0, 0, -0.99996185302734375, 0.008734640665352344, 360, 255, 1, 45942), -- Pod Cluster
(@OGUID+1, 2844, 530, 3524, 3569, "", 0, 0, 0, -1, -4826.92822265625, -11486.4384765625, -37.0933952331542968, 2.321286916732788085, 0, 0, 0.917059898376464843, 0.398749500513076782, 360, 255, 1, 40892), -- Tide's Hollow
(@OGUID+2, 2844, 530, 3524, 3571, "", 0, 0, 0, -1, -4481.47900390625, -11624.3408203125, 11.0514068603515625, 5.35816192626953125, 0, 0, -0.446197509765625, 0.894934535026550292, 360, 255, 1, 45942), -- Bristlelimb Village
(@OGUID+3, 2844, 530, 3524, 3572, "", 0, 0, 0, -1, -3099.85595703125, -12480.6591796875, 0.465005010366439819, 1.012289404869079589, 0, 0, 0.484808921813964843, 0.87462007999420166, 360, 255, 1, 40892), -- Stillpine Hold
(@OGUID+4, 2844, 530, 3524, 3572, "", 0, 0, 0, -1, -3222.1826171875, -12490.9609375, 15.47136592864990234, 1.117009282112121582, 0, 0, 0.529918670654296875, 0.84804844856262207, 360, 255, 1, 45942), -- Stillpine Hold
(@OGUID+5, 2844, 530, 3524, 3577, "", 0, 0, 0, -1, -4600.736328125, -12871.3798828125, 6.40148019790649414, 2.303830623626708984, 0, 0, 0.913544654846191406, 0.406738430261611938, 360, 255, 1, 45942), -- Greezie's Camp
(@OGUID+6, 2844, 530, 3524, 3578, "", 0, 0, 0, -1, -3371.1328125, -12716.5361328125, 19.57845115661621093, 6.056293010711669921, 0, 0, -0.11320304870605468, 0.993571877479553222, 360, 255, 1, 45942), -- Menagerie Wreckage
(@OGUID+7, 2844, 530, 3524, 3639, "", 0, 0, 0, -1, -5200.96875, -11046.71875, 26.86562156677246093, 0.575957298278808593, 0, 0, 0.284014701843261718, 0.958819925785064697, 360, 255, 1, 40892); -- Silvermyst Lsle
