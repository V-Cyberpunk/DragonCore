...
ALTER TABLE `character_loadout` MODIFY `ItemContext` tinyint SIGNED NOT NULL DEFAULT 0 AFTER `Purpose`;
...
ALTER TABLE `garr_follower` MODIFY `Quality` tinyint UNSIGNED NOT NULL DEFAULT 0 AFTER `AllianceGarrClassSpecID`;
...
ALTER TABLE `modified_crafting_reagent_slot` MODIFY `Field_10_0_2_46091_005` tinyint UNSIGNED NOT NULL DEFAULT 0 AFTER `ReagentType`;
...
ALTER TABLE `spell_reagents` MODIFY `SpellID` int SIGNED NOT NULL DEFAULT 0 AFTER `ID`;
