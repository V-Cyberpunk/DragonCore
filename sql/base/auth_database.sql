...
(1,'DragonCore','127.0.0.1','127.0.0.1','255.255.255.0',8085,0,0,1,0,0,55664,1,1);
...
CREATE TABLE `uptime` (
  ...
  `revision` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Dragoncore',
